...
var MostToLeast_1 = require("./MostToLeast");
describe('MostToLeast Transcoder', function () {
    test('encode one byte', function () {
        var i = new MostToLeast_1.MostToLeast(1);
    ...
    test('encode two bytes', function () {
        var i = new MostToLeast_1.MostToLeast(2);
...
//# sourceMappingURL=MostToLeast.spec.js.map